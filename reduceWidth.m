% Function to reduce the width of image by removing one vertical seam
% Inputs:
%   im: nrows-by-ncols-by-3 matrix of class uint8
%   display_flag: if true, display energy map, cumulative map, and seam
% Outputs:
%   reducedColorImage: nrows-by-(ncols-1)-by-3 matrix of class uint8
